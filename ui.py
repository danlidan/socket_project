...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_curchat.setGeometry(QtCore.QRect(10, 40, 561, 16))
        ...
        self.label_welcome.setGeometry(QtCore.QRect(10, 10, 72, 15))
        self.label_welcome.setObjectName("label_welcome")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(410, 10, 71, 31))
        self.pushButton.setObjectName("pushButton")
        self.lineEdit_nick = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_nick.setGeometry(QtCore.QRect(490, 20, 91, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "修改昵称"))
